...
//
//// Global Variables
//const char* APP_TITLE = "OpenGL - My Scene";
...
//
//
//FPSCamera fpsCamera(glm::vec3(10.0f, 10.0f, 20.0f));
...
//
//		// Point Light 1
//		lightingShader.setUniform("pointLights[0].ambient", glm::vec3(0.9f, 0.9f, 0.9f));
...
//		lightingShader.setUniform("pointLights[0].linear", 0.01f);
//		lightingShader.setUniform("pointLights[0].exponent", 0.002f);
//
//		// Render the scene
